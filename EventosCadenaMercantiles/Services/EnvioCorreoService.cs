...
namespace EventosCadenaMercantiles.Services
{
    public static class EnvioCorreoService
    {
        ...
        public static bool EnviarCorreoAlEmisor(string resultado, string tipoEvento, string documento)
        {
            try
            {
                var mensaje = new MailMessage
                {
                    ...
                    Subject = $"Notificación de Evento {tipoEvento} - {"documento.PrefijoFactura"}",
                        ...
                        <div class='card'>
                            ...
                            <div class='contenido'>
                                ...
                                <div class='info'>
                                    ...
                                    <p><strong>Prefijo y número del documento:</strong> {"SETT050292"}</p>
